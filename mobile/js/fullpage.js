...
var myFullpage = new fullpage('#fullpage', {
  ...
  responsiveWidth: 1201, // width값 이후로 fullpage 적용
...
;(function () {
    ...
    // Fullpage main slider : move to current slide when clicked to Number.
    var sliderList = $('.desc-pager li');
    sliderList.on('click', function(e){
        var index = $(this).index();
        var sliderList = $('.fp-slidesContainer .fp-slide');
        sliderList.siblings().removeClass('active');
        sliderList.eq(index).addClass('active');
